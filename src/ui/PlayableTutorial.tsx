import type { PieceId, ViewMode } from "../game/types";
...
export const tutorialSteps: TutorialStep[] = [
  {
    ...
    target: "Follow the arrow to D4 first. The other highlighted squares are the houses that must receive light.",
  ...
  },
  {
    ...
    target: "Use the arrow at the top tab control: YESOD is Before, MALKUT is After.",
  ...
  {
    title: "Protector",
    target: "Follow the arrow to D5 and click the Protector.",
    ...
    primarySquare: "D5",
    selectedPiece: "protector",
    view: "now"
  },
  {
    title: "Binder",
    target: "The arrow starts at C4. The Lock button is also marked so you know the next control to press.",
    ...
    primarySquare: "C4",
    selectedPiece: "binder",
    view: "now",
    actions: ["lock"]
  },
  {
    title: "Looser",
    target: "The arrow starts at E4. When a real lock exists, the marked Release button opens it.",
    ...
    primarySquare: "E4",
    selectedPiece: "looser",
    view: "now",
    actions: ["release"]
  },
  {
    title: "Destroyer",
    target: "Follow the arrow to D3. When darkness appears, click its highlighted tile to attack and answer the verse check.",
    ...
    primarySquare: "D3",
    selectedPiece: "destroyer",
    view: "coming",
    actions: ["attack"]
  },
  {
    title: "Build",
    target: "Follow the arrow to D6. The Build button is marked when a selected player is standing on a buildable square.",
  ...
  },
  {
    ...
    target: "The arrow points to End turn. After pressing it, read the highlighted bottom console line.",
